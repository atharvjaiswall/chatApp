...
const ProfilePage = () =>{
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      {/* through onSubmit handleSubmit as sonn as we will save the dtils we will navigate to the home page */}
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <button type="Submit" className='bg-linear-to-r from-purple-400 to-violet-600 text-white p-2 rounded-full text-lg cursor-pointer'>Save
          </button>
        </form>
