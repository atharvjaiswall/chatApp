...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      {/* Shows the current state (like “Sign up” or “Login”).
      If the user has submitted the form, show a back arrow icon.
      If they click the arrow → reset isDataSubmitted to false → form reappea */}
          {currState}
          ...
          {/* In the sign up page this full name will be visible but in login page this name part wil not be visible */}
...

          {
            currState==="Sign up" && isDataSubmitted && (
              ...
              {/* ....to check the button will be off login user or of the create account.... */}
          <button type='submit' className='py-3 bg-linear-to-r from-purple-400 to-violet-600 text-white rounded-md cursor-pointer'>{currState==="Sign up" ? "Create Account" :"Login Now"}</button>

          <div className='flex items-center gap-2 text-sm text-gray-500'>
            <input type="checkbox" />
            <p>Agree to the terms of use & privacy policy</p>
          </div>
        {/* to check if u are a new user or alreay have an account */}
